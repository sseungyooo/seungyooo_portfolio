...
document.querySelector('#closeUpload').addEventListener('click', () => dialog.close());
document.querySelector('#projectForm').addEventListener('submit', (event) => { event.preventDefault(); dialog.close(); alert('작업물은 Login 페이지에서 관리할 수 있습니다.'); });
